...
/* harmony import */ var _logger_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./logger.service */ "Mb37");
...
let DataService = class DataService {
    constructor(_loggerService, _http) {
        this._loggerService = _loggerService;
        this._http = _http;
    ...
    getAllReaders() {
        return this._http.get('/api/errors/500').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    handleError(error) {
...
let DashboardComponent = class DashboardComponent {
    ...
    ngOnInit() {
        ...
        this._dataService.getAllReaders()
            .subscribe(data => this.allReaders = data, err => console.log(err), () => this._loggerService.log('All done getting readers!'));
...
/* harmony import */ var _services_logger_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./services/logger.service */ "Mb37");
/* harmony import */ var _services_data_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./services/data.service */ "EnSQ");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [
            ...
            _services_logger_service__WEBPACK_IMPORTED_MODULE_12__["LoggerService"],
